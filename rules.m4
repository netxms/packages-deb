...
override_dh_auto_configure:
	dh_auto_configure -- --with-server --with-agent --with-client \
		...
		--enable-unicode --with-jdk=/usr/lib/jvm/default-java --with-vmgr CONFIGURE_MARIADB CONFIGURE_MOSQUITTO CONFIGURE_ZMQ CONFIGURE_ORACLE CONFIGURE_ASTERISK CONFIGURE_XEN
